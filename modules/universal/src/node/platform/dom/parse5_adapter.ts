/* MarkPieszak - replace parse5_adapter
...
import {ListWrapper, StringMapWrapper} from '@angular/platform-browser/src/facade/collection';
import {DomAdapter, setRootDomAdapter} from '@angular/platform-browser/src/dom/dom_adapter';
import {isPresent, isBlank, global, Type, setValueOnPath, DateWrapper} from '@angular/platform-browser/src/facade/lang';
...
export class Parse5DomAdapter extends DomAdapter {
  static makeCurrent() {
    ...
    */
    ...
    treeAdapter = parse5.treeAdapters.htmlparse2;
  }
  ...
  getInnerHTML(el: any /** TODO #9100 */): string {
    return serializer.serialize(this.templateAwareRoot(el), treeAdapter);
  }
