...
npm run build:ng-koa-engine

cp modules/ng-koa-engine/package.json dist/ng-koa-engine/package.json
cp modules/ng-koa-engine/README.md dist/ng-koa-engine/README.md
